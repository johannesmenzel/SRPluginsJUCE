...
//==============================================================================
const String JuceTestAudioProcessor::getName() const
{
...
const String JuceTestAudioProcessor::getProgramName (int index)
{
    return {};
}

void JuceTestAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void JuceTestAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* JuceTestAudioProcessor::createEditor()
{
    return new JuceTestAudioProcessorEditor (*this);
}

//==============================================================================
void JuceTestAudioProcessor::getStateInformation (MemoryBlock& destData)
{
